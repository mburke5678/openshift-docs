...
[WARNING]
====
Please see xref:../../logging/config/cluster-logging-storage.adoc[Configuring the log store] for details on configuring the default Jaeger parameters for Elasticsearch in a production environment.
====
