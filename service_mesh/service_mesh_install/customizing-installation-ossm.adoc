...
For more information about configuring Elasticsearch with {product-title}, see  xref:../../logging/config/cluster-logging-storage.adoc[Configuring the log store].
