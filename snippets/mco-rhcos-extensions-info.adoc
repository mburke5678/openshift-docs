...
* **wasm**: The `wasm` extension enables Developer Preview functionality in OpenShift Container Platform (OCP) for users who want to utilize WASM-supported workloads.   

* **sysstat**: The `sysstat` extension enable collection of performance monitoring tools. 
