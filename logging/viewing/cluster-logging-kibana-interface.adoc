...
{product-title} cluster logging includes a web console for visuaizing collected log data. Currently, {product-title} deploys the Kibana console for visualization.

Using the log visualizer, you can:

* Search and browse your data using the Discover tab.
* Chart and map your data using the Visualize tab. You must first xref:../../logging/viewing/cluster-logging-kibana-interface.html#cluster-logging-kibana-visualize_cluster-logging-visualizer[install the Visualize page].
