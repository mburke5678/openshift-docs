...
= Installing the Kibana Visualize tab

You must install Kibana’s *Visualize* tab in order to create visualizations and dashboards for monitoring container logs. 
