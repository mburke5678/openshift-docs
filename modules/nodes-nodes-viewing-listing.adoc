...
----
+
The `STATUS` column in the output of these commands can show nodes with one of the
following statuses:
+
...
The following is a healthy node:
...
Conditions:
  ...
  ----             ------  -----------------                 ------------------                ------                       -------
  MemoryPressure   False   Tue, 09 Mar 2021 16:54:58 -0500   Tue, 09 Mar 2021 08:32:45 -0500   KubeletHasSufficientMemory   kubelet has sufficient memory available
  DiskPressure     False   Tue, 09 Mar 2021 16:54:58 -0500   Tue, 09 Mar 2021 08:32:45 -0500   KubeletHasNoDiskPressure     kubelet has no disk pressure
  PIDPressure      False   Tue, 09 Mar 2021 16:54:58 -0500   Tue, 09 Mar 2021 08:32:45 -0500   KubeletHasSufficientPID      kubelet has sufficient PID available
  Ready            True    Tue, 09 Mar 2021 16:54:58 -0500   Tue, 09 Mar 2021 08:33:25 -0500   KubeletReady                 kubelet is posting ready status
----
...
<6> The node conditions, listed below.
...
The following are the node conditions. The `conditions` stanza lists the `Ready`, `NotReady` (`Ready=False`), and `SchedulingDisabled`.   
