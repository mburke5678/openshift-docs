...
[role="_abstract"]
You can add worker nodes to {sno} clusters that were created on the {cluster-manager-url} by using the link:https://console.redhat.com/openshift/assisted-installer/clusters/~new[Assisted Installer].
