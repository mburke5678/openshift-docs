...
+ 
Also, in automatic mode, if you manually update the boot image, the MCO updates the `MachineConfiguration` object and tests the boot image version for skew. 
+
[NOTE]
====
