...
= Configuring log curation using a CronJob

You can alternatively create, configure, and run log curation using a CronJob. The next scheduled job uses this configuration.
...
To create a cronjob for log curation:
