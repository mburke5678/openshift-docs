...
= WMCO Control Plane Only upgrade by using the web console

You can use the {product-title} web console to perform a Control Plane Only upgrade of the Windows Machine Config Operator (WMCO).
...
[IMPORTANT]
====
Delete the Operator only. Do not delete the Windows namespace or any Windows objects.
====
+
