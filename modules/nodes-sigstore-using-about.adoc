...
You can use the `ClusterImagePolicy` and `ImagePolicy` custom resource definition (CRD) objects to enable and configure Sigstore support at the cluster or namespace scope. These objects specify the images and repositories to be verified and how the signatures must be verified.
