...
= WMCO Control Plane Only upgrade by using the CLI

You can use the {oc-first} to perform a Control Plane Only upgrade of the Windows Machine Config Operator (WMCO).
