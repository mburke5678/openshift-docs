...
With boot image management enabled, you can set boot image skew enforcement to automatically verify that the boot image version is up-to-date for your cluster. For more information, see "Boot image skew enforcement".
