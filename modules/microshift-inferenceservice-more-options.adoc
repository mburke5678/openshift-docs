...
[role="_abstract"]
You can include many different options in yhe inference service YAML file, as described in the link:https://kserve.github.io/website/latest/reference/api/[Control Plane API Reference] (KServe documentation).  
