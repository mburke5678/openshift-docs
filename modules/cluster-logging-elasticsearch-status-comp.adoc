...
= Viewing the status of the logstore components

You can view the status for a number of the logstore components.
...
Logstore pods::
You can view the status of the pods that host the logstore.
...
You can view the status of the logstore deployment configuration.
...
Logstore ReplicaSet::
You can view the status of the logstore ReplicaSet.
