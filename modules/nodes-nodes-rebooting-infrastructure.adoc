...
When rebooting nodes that host critical {product-title} infrastructure components,
ensure that there are at least three nodes available to run the components. 
The nodes that host the infrastructure components are called *master* nodes.
