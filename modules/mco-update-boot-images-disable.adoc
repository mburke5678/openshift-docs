...
`spec.managedBootImages.machineManagers.selection.resource.machinesets`:: Specifies that the `selection` action applies to compute nodes.

`spec.managedBootImages.machineManagers.selection.mode.None`:: Specifies that the feature is disabled for the specified machine sets in the cluster. 
--
...
`spec.managedBootImages.machineManagers.selection.resource.controlplanemachinesets`:: Specifies that the `selection` action applies to control plane nodes.
