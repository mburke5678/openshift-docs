...
`spec.managedBootImages.machineManagers.selection.resource.machinesets`:: Specifies that the `selection.mode` parameter applies to compute nodes.
...
`spec.managedBootImages.machineManagers.selection.resource.controlplanemachinesets`:: Specifies that the `selection.mode` parameter applies to control plane nodes.
