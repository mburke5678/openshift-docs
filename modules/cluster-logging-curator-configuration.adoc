...
= Modifying log curation

You can configure the log curation cron schedule using the Cluster Logging Custom Resource
...
You can edit or replace this ConfigMap to reconfigure log curation.
