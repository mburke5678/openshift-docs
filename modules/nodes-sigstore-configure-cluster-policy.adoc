...
* You have a Sigstore-supported public key infrastructure (PKI), or provide a link:https://docs.sigstore.dev/cosign/[Cosign public and private key pair] for signing operations.
...
<5> Specifies the policy types that define the root of trust, either a public key or a link:https://docs.sigstore.dev/certificate_authority/overview/[Fulcio certification]. Here, a public key with Rekor verification.
...
<3> Specifies the parameters that define how the images are verified.
<4> Defines a root of trust for the policy.
<5> Specifies the policy types that define the root of trust, either a public key or a link:https://docs.sigstore.dev/certificate_authority/overview/[Fulcio certification]. Here, a Fulcio certification with required Rekor verification.
