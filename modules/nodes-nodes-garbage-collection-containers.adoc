...
[NOTE]
====
Setting the `evictionPressureTransitionPeriod` parameter to `0` actually configures the default value of 5 minutes. You cannot set an eviction pressure transition period to zero seconds. 
====
